          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {entry.metadata && entry.metadata.amount && (
                <p className="text-sm font-medium text-pix-600 mt-1">
...
function getActionIcon(action: string) {
  switch (action) {
    ...
    case 'SETTLEMENT_ADDED':
      return (
        <div className="w-8 h-8 bg-pix-100 rounded-full flex items-center justify-center">
          <svg className="w-4 h-4 text-pix-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
